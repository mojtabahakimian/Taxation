...
namespace Prg_Moadian.FUNCTIONS
{
    ...
    public static class MoadianRules
    {
        ...
        ///
        /// پیش‌فرض false و این عمدی است. در داده عملیاتی ۱۳۱۲ صورتحساب با تاخیر
        /// ۱۳ تا ۳۶ روز، *بدون* فیلد insr، با موفقیت ثبت شده‌اند (بیشترین تاخیر
        /// پذیرفته‌شده ۳۶ روز). پس مهلت واقعی این مؤدی از ۱۲ روز بیشتر است و
        /// ست‌کردن خودکار insr=1 ماهیت حقوقی سندی را عوض می‌کند که بدون آن پذیرفته
        /// می‌شد. تا وقتی مهلت واقعی معلوم نشده، رفتار قبلی (ارسال نکردن insr) حفظ
        /// می‌شود و فقط هشدار داده می‌شود.
        /// </summary>
